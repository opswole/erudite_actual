class CourseModulesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to course_modules_path, status: :see_other, notice: "Course module was successfully destroyed." }
  ...
  private
    ...
    def course_module_params
      params.expect(course_module: [ :title, :description, :course_id ])
    end
end
